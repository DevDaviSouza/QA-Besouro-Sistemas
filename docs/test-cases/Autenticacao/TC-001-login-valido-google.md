# TC-001 - Login válido com google - Besouro Sistemas

---

# 1. Objetivo

Este caso de teste visa validar o fluxo de login com dados válidos utilizando login com google
...
2. Clicar em continuar com google nas opções de login
3. Selecionar a conta desejada e confirmar
